...
lib.new = function(self)
	...
	glib.newpage = function(self,title)
		...
		plib.addbutton = function(self,title,desc,callback)
			innum=innum+1
			local button = linstance:create("button")
		...
		plib.addcheckbox = function(self,title,default,callback)
			innum=innum+1
			local toggled = default
			local checkbox = linstance:create("checkbox",{title=title})
		...
		plib.addslider = function(self,title,default,min,max,inc,callback)
			innum=innum+1
			local slider = linstance:create("slider",{title=title})
